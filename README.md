...
Additional credit to [Bruno Crosier](https://github.com/brunocrosier) for making [the nextauth adapter](https://www.npmjs.com/package/@bruno_crosier/edgedb-adapter) for me. Still has some linting issues I promise I'll get around to.
